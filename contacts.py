...
from tkinter import ttk  # provides acces to tk themed widgets
import sqlite3
...
class Contacts:
    ...
    def create_label_frame(self):
        ...
        Button(labelframe, text = 'Add New Contact', command = self.on_add_contact_button_clicked, bg = "blue", fg = "white").grid(row = 4, column = 2, sticky = E, padx = 5, pady = 5)
